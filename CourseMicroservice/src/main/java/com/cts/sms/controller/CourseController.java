...
public class CourseController {
    ...
    @PostMapping("/{courseId}/enroll/{studentId}") // http://localhost:8081/courses/2/enroll/2
    public ResponseEntity<String> enrollStudent(@PathVariable int courseId, @PathVariable int studentId) {
        String message = courseService.enrollStudent(courseId, studentId);
